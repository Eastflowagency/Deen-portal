...
const PLYR_STYLES = `
  ...
  .plyr--fullscreen .plyr__video-wrapper video { object-fit: contain !important; }
  @media (max-width: 767px) and (orientation: landscape) {
    .plyr--fullscreen { width: 100vw !important; height: 100vh !important; }
    .plyr--fullscreen .plyr__video-wrapper { height: 100vh !important; }
    .plyr--fullscreen video { object-fit: contain !important; max-height: 100vh !important; }
  }
...
export default function CoursePage({ params }: { params: Promise<{ niveau: string; subject: string }> }) {
  const { niveau, subject } = use(params)
    ...
    <>
      ...
      <div className="course-bottom-bar" style={{
        ...
        <button onClick={toggle} style={{
          ...
          background: isComplete ? 'rgba(34,197,94,0.18)' : '#fff',
          border: isComplete ? '1px solid rgba(34,197,94,0.5)' : 'none',
          color: isComplete ? '#4ade80' : '#0d1117',
          ...
          {isComplete ? 'Fullført' : 'Marker som fullført'}
        </button>

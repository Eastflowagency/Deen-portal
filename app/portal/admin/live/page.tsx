            ...
            {hands.map((hand) => (
              <div key={hand.id} style={{
                ...
                <div style={{ display: 'flex', gap: 6 }}>
                  {/* Admit to speak */}
                  <button
                    onClick={() => admitStudent(hand)}
                    className="btn-press"
                    title="Tillat å snakke"
                    style={{
                      width: 28, height: 28, borderRadius: 6,
                      background: 'rgba(74,197,120,0.1)',
                      border: '1px solid rgba(74,197,120,0.25)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      color: 'rgba(74,197,120,0.85)', cursor: 'pointer',
                    }}
                  >
                    <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
                  </button>
                  {/* Dismiss without admitting */}
                  <button
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          >
            {publishing ? <span>…</span> : form.isLive ? (
              <><div style={{ width: 7, height: 7, borderRadius: '50%', background: '#ef4444', animation: 'livePulse 1.4s infinite' }} />Avslutt</>
            ) : (
